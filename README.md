...
* Create a new training course
  ...
  2. Create a new [training course post](https://github.com/isomerpages/enterprisesg-sac/new/staging/courses/_posts?filename=YYYY-MM-DD-title-of-course-page.md&value=---%0Alayout:+simple-page%0Atitle:+"Title+of+Course+Page"%0Adate:+YYYY-MM-DD%0Apermalink:+/services/training/courses-2019/title-of-course-page%0Acourse_date:+DD+Month+YYYY%0A%23+Comment:+"course_date"+is+used+for+the+actual+date+of+the+course%0A---)  
